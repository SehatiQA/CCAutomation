...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Consultation Center/Tambah Dokter/dropdown_jenisdokter'), 'ppds', false)

String charset = ('a'..'z').join()
Integer length = 6
String randomString = RandomStringUtils.random(length, charset.toCharArray())

WebUI.setText(findTestObject('Object Repository/Page_Consultation Center/Tambah Dokter/field_namadokter'), 'ppds. auto ' + randomString)
...
WebUI.scrollToElement(findTestObject('Object Repository/Page_Consultation Center/Tambah Dokter/radio_lakilaki'), 0)
