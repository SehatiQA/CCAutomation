...
WebUI.scrollToElement(findTestObject('Object Repository/Page_Consultation Center/Tambah Dokter/button_Simpan'), 0)

WebUI.delay(3)

WebUI.verifyElementNotClickable(findTestObject('Object Repository/Page_Consultation Center/Tambah Dokter/button_Simpan'))
