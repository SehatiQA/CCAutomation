...
WebUI.setText(findTestObject('Object Repository/Page_Consultation Center/Beranda (Admin)/field_caridokter'), 'rudiismanto111@gmail.com')

WebUI.delay(3)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Consultation Center/Beranda (Admin)/emaildokter_onListDokter'), 'rudiismanto111@gmail.com')
