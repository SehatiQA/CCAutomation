...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Consultation Center/Beranda (Dokter)/dropdown_province'), '490', false)

WebUI.delay(3)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Consultation Center/Beranda (Dokter)/provinceJabar_onList'), 'Jawa Barat')
