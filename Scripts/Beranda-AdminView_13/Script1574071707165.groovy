...
WebUI.click(findTestObject('Object Repository/Page_Consultation Center/Beranda (Admin)/section_logout'))

WebUI.delay(2)

WebUI.click(findTestObject('Page_Consultation Center/Beranda (Admin)/option_logout2'))

WebUI.delay(2)

WebUI.verifyElementPresent(findTestObject('Page_Consultation Center/Login_Screen/field_email'), 0)
