...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Consultation Center/Beranda (Admin)/dropdown_statusdoctor'), 'false', false)

WebUI.delay(3)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Consultation Center/Beranda (Admin)/label_tidakaktif'), 0)
