...
WebUI.setText(findTestObject('Object Repository/Page_Consultation Center/Details Pasien/field_interpretasi'), 'interpretasi adalah patology '+randomStrings)

WebUI.delay(2)

WebUI.setText(findTestObject('Object Repository/Page_Consultation Center/Details Pasien/field_instruksi'), 'instruksi adalah patology '+randomStrings)

WebUI.delay(2)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Consultation Center/Details Pasien/dropdown_status'), '12', false)
