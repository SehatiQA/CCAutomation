...
WebUI.setText(findTestObject('Page_Consultation Center/Login_Screen/field_email'), GlobalVariable.inactive)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Consultation Center/Login_Screen/error_inactive account'), 0)
