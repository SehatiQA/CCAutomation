...
WebUI.setText(findTestObject('Object Repository/Page_Consultation Center/Beranda (Admin)/field_caridokter'), 'Qa Kk')

WebUI.delay(3)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Consultation Center/Beranda (Admin)/namadokter1'), 'Qa Kk')
