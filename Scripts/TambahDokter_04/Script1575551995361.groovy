...
WebUI.setText(findTestObject('Object Repository/Page_Consultation Center/Tambah Dokter/field_nohpdokter'), '6789056789')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Consultation Center/Tambah Dokter/inline_phoneexist'), 0)
